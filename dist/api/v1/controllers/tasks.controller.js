...
const index = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const countRecord = yield task_model_1.default.countDocuments(find);
...
const detail = function (req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const task = yield task_model_1.default.findOne(find);
        ...
        try {
            ...
            switch (key) {
                case KEY.STATUS:
                    ...
                    break;
                case KEY.DELETED:
                    yield task_model_1.default.updateMany({ _id: ids }, {
                        deleted: true,
                        deletedAt: new Date()
                    });
